...
//                 path: "mainModel>/updatebusinesspartner",
//                 template: oTemplate,
//                 templateShareable: true
//             }).setKeyboardMode(sKeyboardMode);
//         },

//      // create 2 functions onInputChange & refreshModel. These will handle the input changes.
//         onInputChange: function(){
//             this.refreshModel("mainModel");

//         },
        
//          refreshModel: function (mainModel, groupId){
...
//         // add a method makeChangesAndSubmit to Save or to do the Update Operation.
//         makeChangesAndSubmit: function (resolve, reject, mainModel,groupId){
//             mainModel = "mainModel";
//             groupId = "$auto";
//             if (this.getView().getModel(mainModel).hasPendingChanges(groupId)) {
//                 this.getView().getModel(mainModel).submitBatch(groupId).then(() =>{
//                     this.makeChangesAndSubmit(resolve,reject, mainModel,groupId);
...
//                   });
//             } else {
//                 this.getView().getModel(mainModel).refresh(groupId);
//                 resolve();
//             }
//         },

//         //  add an onSave Function to Switch back to Display Mode.
//         onSave: function(){
...
//                         "Node_Key": this.byId("idNode").getValue(),
//                         "BP_Role": this.byId("idBP_role").getValue(),
//                         "Email_Address": this.byId("idEmail").getValue(),
//                         "Phone_Number": this.byId("idPhn").getValue(),
//                         "Fax_Number": this.byId("idFax").getValue(),
//                         "BP_ID": this.byId("idBPId").getValue(),
//                         "Company_Name": this.byId("idCompanyName").getValue()      
//                     });
//                     oContext.created()
//                     .then(()=>{
//                             // this._focusItem(oList, oContext);
...
//             // call this function in onEditMode to make them editable by pressing Edit Button.
...
//     //     var oSelect = this.byId("table0").getSelectedItem();
//     //     if(oSelect){
//     //         var oSalesOrder = oSelect.getBindingContext("mainModel").getObject().Node_Key;
//     //     }else {
//     //         MessageToast.show("Please Select a Row to upate");
//     //     }
